/* Hundir la Flota
  ...
  */
  ...
  int main() {
	  int const barcoMasPequenyo = 3, barcoMasGrande = 6;
  ...
  #pragma region tableros
	  ...
	  for (int i = 0; i < FILAS; i++)
	  {
		  for (int j = 0; j < COLUMNAS; j++)
		  {
			  ...
			  tableroGameplayJugador1[i][j] = AGUA;
			  tableroGameplayJugador2[i][j] = AGUA;
		  }
	  }
	  ...
	  for (int i = 3; i <= 6; i++)
	  {
		  ...
		  while (!barcoColocado)
		  {
			  ...
			  for (int j = 1; j <= 4; j++)
			  {
				  ...
				  if (tableroJugador1[posicionAleatoriaFila][posicionAleatoriaColumna] == AGUA)
				  {
					  ...
					  if (j == 1 && posicionAleatoriaColumna + i < COLUMNAS)
					  {
						  ...
						  for (int k = 0; k < i; k++)
						  {
							  ...
							  if (tableroJugador1[posicionAleatoriaFila][posicionAleatoriaColumna + k] != AGUA)
							  {
								  superpuesto = true;
								  break;
							  }
					  ...
					  else if (j == 2 && posicionAleatoriaFila - i >= 0)
					  {
						  ...
						  {
							  // Comprobamos si esas posiciones son agua o un barco. Si es diferente a agua decimos que está superpuesto y salimos del bucle.
							  if (tableroJugador1[posicionAleatoriaFila - k][posicionAleatoriaColumna] != AGUA)
							  {
								  superpuesto = true;
								  break;
							  }
		  ...
		  while (!barcoColocado)
		  {
			  ...
			  for (int j = 1; j <= 4; j++)
			  {
				  ...
				  // Comprobamos si la posición inicial es agua o barco. Si es agua procedemos a hacer más comprobaciones. Si no, regeneramos la posición inicial.
				  if (tableroJugador2[posicionAleatoriaFila][posicionAleatoriaColumna] == AGUA)
				  {
					  // Para la direccion 1 (derecha) y además comprobamos si el barco queda dentro del tablero e inicia el for.
					  if (j == 1 && posicionAleatoriaColumna + i < COLUMNAS)
					  {
						  ...
						  {
							  // Comprobamos si esas posiciones son agua o un barco. Si es diferente a agua decimos que está superpuesto y salimos del bucle.
							  if (tableroJugador2[posicionAleatoriaFila][posicionAleatoriaColumna + k] != AGUA)
							  {
								  superpuesto = true;
								  break;
							  }
					  ...
					  else if (j == 2 && posicionAleatoriaFila - i >= 0)
					  {
						  ...
						  {
							  // Comprobamos si esas posiciones son agua o un barco. Si es diferente a agua decimos que está superpuesto y salimos del bucle.
							  if (tableroJugador2[posicionAleatoriaFila - k][posicionAleatoriaColumna] != AGUA)
							  {
								  superpuesto = true;
								  break;
							  }
	  ...
	  while (cantidadOsJugador1 < cantidadOsTotal && cantidadOsJugador2 < cantidadOsTotal)
	  {
		  ...
		  if (contadorTurno % 2 == 0)
		  {
			  ...
			  do
			  {
				  ...
				  if (tableroGameplayJugador2[fila][columna] != AGUA)
				  {
					  std::cout << "Esa posicion ya ha sido atacada." << std::endl;
				  }
  
			  } while (tableroGameplayJugador2[fila][columna] != AGUA);
  
			  if (tableroJugador2[fila][columna] == AGUA)
			  {
				  tableroGameplayJugador2[fila][columna] = FALLO;
			  }
			  else
			  {
				  tableroGameplayJugador2[fila][columna] = ACIERTO;
				  cantidadOsJugador1++;
		  ...
		  else
		  {
			  ...
			  // Filtramos la respuesta del usuario para asegurarnos de que introduce un numero valido y no repetido.
			  do
			  {
				  do
				  {
				  ...
				  if (tableroGameplayJugador1[fila][columna] != AGUA)
				  {
					  std::cout << "Esa posicion ya ha sido atacada." << std::endl;
				  }
  
			  } while (tableroGameplayJugador1[fila][columna] != AGUA);
  
			  // Comprobamos si el jugador ha acertado y en funcion de ello ponemos en la posicion X (fallo) u O (acierto).
			  if (tableroJugador1[fila][columna] == AGUA)
			  {
				  tableroGameplayJugador1[fila][columna] = FALLO;
			  }
			  else
			  {
				  tableroGameplayJugador1[fila][columna] = ACIERTO;
				  cantidadOsJugador2++;
		  ...
		  // Incrementamos el contador para cambiar de turno.
		  contadorTurno++;
	  }
  
	  // Una vez salimos del bucle (es decir que uno de los dos jugadores ha alcanzado la cantidad de O's necesaria) comprobamos cual de los dos es para decir quién ha ganado.
	  if (cantidadOsJugador1 >= cantidadOsTotal)
	  {
		  //Imprimimos el tablero del jugador contrario para que el jugador actual pueda visualizar mejor la posición a atacar.
